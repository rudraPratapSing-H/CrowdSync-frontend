...
const OverviewBanner = () => {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      {/* Total in Venue */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 flex flex-col items-center text-center hover:shadow-md transition-shadow">
      ...
      {/* Total Zones */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 flex flex-col items-center text-center hover:shadow-md transition-shadow">
        <div className="w-10 h-10 bg-green-50 rounded-md flex items-center justify-center mb-2">
          <svg
        ...
        <div className="text-base font-medium text-gray-700">Total Zones</div>
        <div className="text-xs text-gray-500">Active monitoring</div>
      </div>

      {/* Peak Occupancy */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 flex flex-col items-center text-center hover:shadow-md transition-shadow">
        <div className="w-10 h-10 bg-cyan-50 rounded-md flex items-center justify-center mb-2">
          <svg
